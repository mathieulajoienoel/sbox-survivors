using Sandbox.UI;
public sealed class Health3 : UpgradeBoon {
  [Property] public override string Name { get; set; } = "Health 3"; // The name of the upgrade
  [Property] public override Image Image { get; set; } = null; // Image to show
  [Property] public override string Description { get; set; } = "+5 max health"; // Short description of the upgrade
  [Property] public override int Cost { get; set; } = 0; // Cost of the attribute upgrade
  [Property] public override AttributeUpgradeRarity Rarity { get; set; } = AttributeUpgradeRarity.Uncommon; // Upgrade rarity, lower is more common
  ...
  [Property] public override float Value { get; set; } = 5; // Value to apply
