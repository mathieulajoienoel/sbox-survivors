using Sandbox.UI;
public sealed class Health2 : UpgradeBoon {
  [Property] public override string Name { get; set; } = "Health 2"; // The name of the upgrade
  [Property] public override Image Image { get; set; } = null; // Image to show
  [Property] public override string Description { get; set; } = "+2 max health"; // Short description of the upgrade
  ...
  [Property] public override float Value { get; set; } = 2; // Value to apply
